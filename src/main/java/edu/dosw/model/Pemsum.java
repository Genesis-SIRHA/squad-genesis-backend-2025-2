...
/**
 * Represents a student's academic record summary, including courses and credits.
 * This class is immutable and should be constructed using its Builder.
 */
public class Pemsum {
     ...
     */
    public String getFacultyPlan() { return facultyPlan; }
    
    /**
     * @return The total number of credits the student has approved.
     */
    public int getApprovedCredits() { return approvedCredits; }
     ...
     */
    public Map<Course, String> getCourses() { return courses; }

    /**
     * Builder class for creating immutable Pemsum instances.
