...
/**
 * Data Transfer Object representing a session in the academic schedule.
 * Contains information about the room, time slot, and day of the week for a session.
 */
public class SessionDTO {
    /**
     * The name of the room where the session takes place.
     * Cannot be blank.
     */
    ...
    /**
     * The day of the week when the session occurs.
     * Cannot be null.
     */
