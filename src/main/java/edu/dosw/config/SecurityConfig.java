...
import edu.dosw.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(
                        ...
                        "/swagger-ui/**",
                        "/webjars/**",
                        "/auth/login") // ✅ Only login is public
                    .permitAll()
                    .anyRequest()
                    .authenticated())
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(
        Arrays.asList("http://localhost:5173", "http://localhost:3000", "http://localhost:5174", "https://squad-genesis-frontend-2025-2.vercel.app"));
