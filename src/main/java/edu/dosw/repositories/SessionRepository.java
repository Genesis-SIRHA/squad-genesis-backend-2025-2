...
public interface SessionRepository extends MongoRepository<Session, String> {
  ...
  Session getSessionByScheduleAndClassroom(String classRoom, Integer slot, DayOfWeek day, String year, String period);

  @Query("{  'slot': ?0, 'day': ?1, 'year': ?2, 'period': ?3 }")
  Session getSessionByScheduleAndGroupCode(String groupCode, Integer slot, DayOfWeek day, String year, String period);
}
