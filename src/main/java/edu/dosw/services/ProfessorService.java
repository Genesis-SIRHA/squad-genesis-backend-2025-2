...
public class ProfessorService {
    ...
    public Professor createProfessor(ProfessorDto professorCreationRequest) {
        if (professorCreationRequest.identityDocument() == null || professorCreationRequest.fullName() == null){
        ...
        try{
            ...
            throw new BusinessException("An inesperated error has occurred when creating the professor: "+ e.getMessage());
        }

    }

    /**
     * Generates an email address for a professor based on their full name.
    ...
    public Professor updateProfessor(String professorId, ProfessorDto professorUpdateRequest) {
        ...
        if (professorUpdateRequest.fullName() != null) professor.setFullName(professorUpdateRequest.fullName());
        if (professorUpdateRequest.identityDocument() != null) professor.setIdentityDocument(professorUpdateRequest.identityDocument());
        if (professorUpdateRequest.facultyName() != null) professor.setFacultyName(professorUpdateRequest.facultyName());

        try{
            return professorRepository.save(professor);
        }catch (Exception e){
            throw new BusinessException("An inesperated error has occurred when updating the professor: "+ e.getMessage());
        }
    }
    ...
    public Professor deleteProfessor(String professorId) {
        ...
        try{
            ...
            throw new BusinessException("An inesperated error has occurred when deleting the professor:" +e.getMessage());
        }
    }
