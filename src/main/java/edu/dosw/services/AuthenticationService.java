...
public class AuthenticationService {
    ...
    public void createAuthentication(User user) {
        ...
        UserCredentialsDto userCredentialsDto = new UserCredentialsDto(id, user.getUserId(), user.getEmail(), password);
        userCredentialsRepository.save(userCredentialsDto);
    }

    public void deleteAuthentication(User user) {
        Optional<UserCredentialsDto> userCredentialsDto = userCredentialsRepository.findByEmail(user.getEmail());
