...
public class AdministratorController {
    ...
    @Operation(summary = "Get administrator by ID", description = "Retrieves a administrator by its unique identifier")
    ...
    public ResponseEntity<Administrator> createAdministrator(@RequestBody AdministratorDto administratorCreationRequest) {
        return ResponseEntity.ok(administratorService.createAdministrator(administratorCreationRequest));
    }

    @PatchMapping("/update/{administratorId}")
    @Operation(summary = "Update administrator", description = "Updates an existing administrator")
    public ResponseEntity<Administrator> updateAdministrator(@RequestBody AdministratorDto administratorUpdateRequest,
                                                 @PathVariable String administratorId) {
        return ResponseEntity.ok(administratorService.updateAdministrator(administratorId, administratorUpdateRequest));
    }
