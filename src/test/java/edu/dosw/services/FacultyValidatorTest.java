...
class FacultyValidatorTest {
  ...
  @InjectMocks private FacultyValidator facultyValidator;
  ...
  void validateAddCourses_WithValidFirstSemesterCourses_ShouldNotThrowException() {
    ...
    CoursesDto coursesDto = new CoursesDto(Map.of("1", List.of(course1, course2)));
  ...
  void validateAddCourses_WithFirstSemesterCoursesHavingRequisites_ShouldThrowException() {
    ...
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class, () -> facultyValidator.validateAddCourses(coursesDto));
  ...
  @Test
  void
      validateAddCourses_WithMultipleInvalidRequisites_ShouldThrowExceptionWithAllInvalidRequisites() {
    Course semester1Course1 = new Course();
    semester1Course1.setAbbreviation("MATH101");
    semester1Course1.setRequisites(List.of());
