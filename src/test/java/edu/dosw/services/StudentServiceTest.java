...
class StudentServiceTest {
  ...
  void createStudent_WithNullIdentityDocument_ShouldThrowValidationException() {
    StudentDto invalidDto =
        new StudentDto(
            null, "Juan Carlos Perez Gomez", PLAN, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
  ...
  void createStudent_WithNullFullName_ShouldThrowValidationException() {
    StudentDto invalidDto =
        new StudentDto("12345678", null, PLAN, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
  ...
  void createStudent_WithNullPlan_ShouldThrowValidationException() {
    StudentDto invalidDto =
        new StudentDto(
            "12345678", "Juan Carlos Perez Gomez", null, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
  ...
  void createStudent_WithNullFacultyName_ShouldThrowValidationException() {
    StudentDto invalidDto =
        new StudentDto(
            "12345678", "Juan Carlos Perez Gomez", PLAN, null, AcademicGrade.UNDERGRADUATE);
  ...
  void createStudent_WhenAuthenticationServiceThrowsException_ShouldThrowBusinessException() {
    ...
    doThrow(new RuntimeException("Authentication service error"))
        ...
        .createAuthentication(any(Student.class));

    BusinessException exception =
        assertThrows(BusinessException.class, () -> studentService.createStudent(validStudentDto));

    assertTrue(
        exception
            .getMessage()
            .contains("An inesperated error has occurred when creating the student"));
    verify(studentRepository, never()).save(any(Student.class));
  }
  ...
  void updateStudent_WhenStudentExists_ShouldUpdateAllFieldsSuccessfully() {
    StudentDto updateDto =
        new StudentDto(
            "87654321", "Juan Carlos Perez Garcia", "New Plan", "Science", AcademicGrade.GRADUATED);
  ...
  void updateStudent_WhenOnlyAcademicGradeProvided_ShouldUpdateOnlyAcademicGrade() {
    StudentDto academicGradeOnlyUpdateDto =
        new StudentDto(null, null, null, null, AcademicGrade.GRADUATED);
  ...
  void updateStudent_WhenRepositoryThrowsException_ShouldThrowBusinessException() {
    ...
    assertTrue(
        exception
            .getMessage()
            .contains("An inesperated error has occurred when updating the student"));
    verify(studentRepository, times(1)).save(any(Student.class));
  }
  ...
  void deleteStudent_WhenAuthenticationDeletionFails_ShouldThrowBusinessException() {
    ...
    doThrow(new RuntimeException("Auth deletion failed"))
        .when(authenticationService)
        .deleteAuthentication(existingStudent);
  ...
  void createStudent_WithSpecialCharactersInName_ShouldGenerateValidEmail() {
    StudentDto studentWithSpecialChars =
        new StudentDto(
            "99999999", "José María Pérez", PLAN, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
  ...
  void updateStudent_VerifyAllFieldsCanBeUpdatedSimultaneously() {
    StudentDto updateDto =
        new StudentDto(
            "11111111", "New Full Name", "New Plan", "New Faculty", AcademicGrade.GRADUATED);
  ...
  void createStudent_WithNameContainingMultipleSpaces_ShouldGenerateCorrectEmail() {
    StudentDto studentWithExtraSpaces =
        new StudentDto(
            "55555555",
  ...
  void createStudent_WithAllAcademicGrades_ShouldCreateSuccessfully() {
    AcademicGrade[] grades = {
      AcademicGrade.UNDERGRADUATE,
      AcademicGrade.POSTGRADUATE,
      AcademicGrade.MASTERS_DEGREE,
  ...
  void createStudent_WithNullAcademicGrade_ShouldCreateWithNullGrade() {
    StudentDto dtoWithNullGrade =
        new StudentDto("12345678", "Carlos Andres Lopez", PLAN, FACULTY_NAME, null);
  ...
  void createStudent_WithNameHavingExactlyThreeParts_ShouldGenerateCorrectEmail() {
    StudentDto studentWithThreeParts =
        new StudentDto(
            "55555555", "Ana Maria Lopez", PLAN, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
  ...
  void createStudent_WithNameHavingFourParts_ShouldGenerateCorrectEmail() {
    StudentDto studentWithFourParts =
        new StudentDto(
            "66666666", "Juan Carlos Perez Gomez", PLAN, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
  ...
  void createStudent_WithInvalidNameForEmailGeneration_ShouldThrowValidationException() {
    StudentDto invalidNameDto =
        new StudentDto("12345678", "Nombre", PLAN, FACULTY_NAME, AcademicGrade.UNDERGRADUATE);
