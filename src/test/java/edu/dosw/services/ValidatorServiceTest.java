...
class ValidatorServiceTest {
    ...
    void setUp() {
        ...
        joinRequest = new CreateRequestDto(
                "STU001",
                RequestType.JOIN,
                "Join request",
                null,
        ...
        swapRequest = new CreateRequestDto(
                "STU001",
                RequestType.SWAP,
                "Swap request",
                "GROUP001",
        ...
        cancellationRequest = new CreateRequestDto(
                "STU001",
    ...
    void validateCreateRequest_SwapRequest_WithoutOriginGroup_ShouldThrowException() {
        CreateRequestDto invalidSwapRequest = new CreateRequestDto(
                "STU001", RequestType.SWAP, "Swap request", null, "GROUP002"
        );

        assertThrows(BusinessException.class,
                () -> validatorService.validateCreateRequest(invalidSwapRequest));
    }
    ...
    void validateUpdateRequest_WithNullUser_ShouldThrowResourceNotFoundException() {
        ...
        UpdateRequestDto updateRequestDto = new UpdateRequestDto("REQ001", RequestStatus.ACCEPTED, "Approved", "ADMIN001");
    ...
    void validateUpdateRequest_WithNullStatus_ShouldThrowBusinessException() {
        ...
        Request request = new Request();
        request.setStatus(RequestStatus.PENDING);
        UpdateRequestDto updateRequestDto = new UpdateRequestDto("REQ001", null, "Approved", "ADMIN001");
    ...
    void validateUpdateRequest_WithNonPendingToPending_ShouldThrowBusinessException() {
        ...
        Request request = new Request();
        request.setStatus(RequestStatus.ACCEPTED);
        UpdateRequestDto updateRequestDto = new UpdateRequestDto("REQ001", RequestStatus.PENDING, "Revert", "ADMIN001");
    ...
    void validateUpdateRequest_WithValidData_ShouldNotThrowException() {
        ...
        assertDoesNotThrow(() -> validatorService.validateUpdateRequest(userId, request, updateRequestDto));
    }
    ...
    void validateFacultyName_WithInvalidFaculty_ShouldThrowBusinessException() {
        ...
        assertThrows(BusinessException.class,
                () -> validatorService.validateFacultyName("InvalidFaculty"));
    }
}