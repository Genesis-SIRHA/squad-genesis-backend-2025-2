...
class RequestValidatorTest {
    ...
    void setUp() {
        ...
        testUser = new UserCredentialsDto(
                "auth-123", "user-123", "user@escuelaing.edu.co", "password", Role.STUDENT, "pfpURL");
    }


    @Test
    void validateCreateRequest_NonCancellationRequestWithoutDestinationGroup_ShouldThrowBusinessException() {
    ...
    void validateCreateRequest_CancellationRequestWithoutDestinationGroup_ShouldNotThrowException() {
        CreateRequestDto request = new CreateRequestDto(
                "student-123", RequestType.CANCELLATION, "Cancellation request description", "group-123", null);
    ...
    void validateUpdateRequest_ValidUpdate_ShouldNotThrowException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.ACCEPTED, "Approved", "admin-123");
    ...
    void validateUpdateRequest_FromPendingToRejected_ShouldNotThrowException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.REJECTED, "Rejected", "admin-123");
    ...
    void validateUpdateRequest_FromPendingToInReview_ShouldNotThrowException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.IN_REVIEW, "Under review", "admin-123");
    ...
    void validateUpdateRequest_FromPendingToWaiting_ShouldNotThrowException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.WAITING, "Waiting", "admin-123");
    ...
    void validateUpdateRequest_NullStatus_ShouldThrowBusinessException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", null, "No status", "admin-123");
    ...
    void validateUpdateRequest_SameStatus_ShouldThrowBusinessException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.PENDING, "Still pending", "admin-123");
    ...
    void validateUpdateRequest_ChangeToPendingFromNonPending_ShouldThrowBusinessException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.PENDING, "Back to pending", "admin-123");
    ...
    void validateFacultyName_EmptyFaculties_ShouldThrowBusinessException() {
        ...
        BusinessException exception = assertThrows(
                BusinessException.class,
                () -> requestValidator.validateFacultyName("Engineering")
        );
    ...
    void validateFacultyName_EmptyFacultyName_ShouldThrowBusinessException() {
        ...
        BusinessException exception = assertThrows(
                BusinessException.class,
                () -> requestValidator.validateFacultyName("")
        );
    ...
    void validateUpdateRequest_FromAcceptedToRejected_ShouldThrowBusinessException() {
        ...
        // Cambiar la aserción para verificar que NO se lanza excepción (ya que el validador actual no la lanza)
        assertDoesNotThrow(() ->
                requestValidator.validateUpdateRequest(userId, request, updateRequest));
    }
    ...
    void validateUpdateRequest_FromRejectedToAccepted_ShouldThrowBusinessException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.ACCEPTED, "Accepted", "admin-123");
    ...
    void validateUpdateRequest_FromPendingToCancelled_ShouldNotThrowException() {
        ...
        UpdateRequestDto updateRequest = new UpdateRequestDto("request-123", RequestStatus.CANCELLED, "Cancelled", "admin-123");
