...
class RequestPeriodValidatorTest {
  ...
  @InjectMocks private RequestPeriodValidator requestPeriodValidator;

  private RequestPeriodDTO validRequestPeriodDTO;

  @BeforeEach
  void setUp() {
    validRequestPeriodDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 30), "2024", "1", true);
  }
  ...
  void currentYearValidator_WithValidYear_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.currentYearValidator(validRequestPeriodDTO));
  }
  ...
  void currentYearValidator_WithInvalidYear_ShouldThrowBusinessException() {
    ...
    RequestPeriodDTO invalidYearDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 30), "2023", "1", true);
    ...
    assertEquals(
        "This year is invalid because is not the current year: 2023", exception.getMessage());
  }
  ...
  void currentPeriodValidator_WithValidPeriod_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.currentPeriodValidator(validRequestPeriodDTO));
  }
  ...
  void currentPeriodValidator_WithInvalidPeriod_ShouldThrowBusinessException() {
    ...
    RequestPeriodDTO invalidPeriodDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 30), "2024", "2", true);
    ...
    assertEquals(
        "This period is invalid because is not the current period: 2", exception.getMessage());
  }
  ...
  void initialDateValidator_WithValidInitialDate_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.initialDateValidator(validRequestPeriodDTO));
  }
  ...
  void initialDateValidator_WithInitialDateAfterFinalDate_ShouldThrowBusinessException() {
    ...
    RequestPeriodDTO invalidDateDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2024, 2, 1), LocalDate.of(2024, 1, 30), "2024", "1", true);
  ...
  void initialDateValidator_WithInitialDateInDifferentYear_ShouldThrowBusinessException() {
    ...
    RequestPeriodDTO invalidYearDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2023, 12, 15), LocalDate.of(2024, 1, 30), "2024", "1", true);
  ...
  void finalDateValidator_WithValidFinalDate_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.finalDateValidator(validRequestPeriodDTO));
  }
  ...
  void finalDateValidator_WithFinalDateInDifferentYear_ShouldThrowBusinessException() {
    ...
    RequestPeriodDTO invalidYearDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2024, 12, 15), LocalDate.of(2025, 1, 5), "2024", "1", true);
  ...
  void createRequestPeriod_WithValidData_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.createRequestPeriod(validRequestPeriodDTO));
  }
  ...
  void updateRequestPeriod_WithValidData_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.updateRequestPeriod(validRequestPeriodDTO));
  }
  ...
  void updateRequestPeriod_WithInvalidPeriod_ShouldThrowBusinessException() {
    ...
    RequestPeriodDTO invalidDTO =
        new RequestPeriodDTO(
            "period-123", LocalDate.of(2024, 1, 15), LocalDate.of(2024, 1, 30), "2024", "2", true);

    BusinessException exception =
        assertThrows(
            BusinessException.class, () -> requestPeriodValidator.updateRequestPeriod(invalidDTO));
  ...
  void finalDateValidator_WithFinalDateInCurrentYear_ShouldNotThrowException() {
    ...
    assertDoesNotThrow(() -> requestPeriodValidator.finalDateValidator(validDTO));
  }
}
