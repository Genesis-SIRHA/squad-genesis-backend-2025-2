...
//    when(requestService.updateRequest("123", Status.ACCEPTED)).thenReturn(request);
//
//    ResponseEntity<Request> response =
//        requestController.updateRequest("123", Status.ACCEPTED);
//
//    assertEquals(200, response.getStatusCodeValue());
//    assertEquals(Status.ACCEPTED, response.getBody().getStatus());
//    verify(requestService, times(1)).updateRequest("123", Status.ACCEPTED);
//  }
//
//  @Test
...
//    verify(requestService, times(1)).updateRequest("123", Status.CANCELLED);
//  }
//
//  @Test
