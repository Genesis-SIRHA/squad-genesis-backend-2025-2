...
class AdministratorControllerTest {
  ...
  void createAdministrator_WithValidData_ShouldReturnCreatedAdministrator() {
    ...
    ResponseEntity<Administrator> response =
        administratorController.createAdministrator(creationRequest);
  ...
  void createAdministrator_WithInvalidData_ShouldThrowException() {
    ...
    assertThrows(
        RuntimeException.class, () -> administratorController.createAdministrator(invalidRequest));
  ...
  void deleteAdministrator_WhenAdministratorNotExists_ShouldThrowException() {
    ...
    assertThrows(
        RuntimeException.class, () -> administratorController.deleteAdministrator(administratorId));
    verify(administratorService, times(1)).deleteAdministrator(administratorId);
  }
