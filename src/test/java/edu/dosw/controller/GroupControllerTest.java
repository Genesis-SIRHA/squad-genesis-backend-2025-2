...
class GroupControllerTest {
    ...
    void getGroupByCode_WhenGroupExists_ShouldReturnGroup() {
        ...
        Group expectedGroup = new Group.GroupBuilder()
                .groupCode(groupCode)
    ...
    void getGroupByCode_WhenGroupNotExists_ShouldThrowException() {
        ...
        assertThrows(RuntimeException.class, () ->
                groupController.getGroupByCode(groupCode));
        verify(groupService, times(1)).getGroupByGroupCode(groupCode);
    }

    @Test
    void createGroup_WithValidData_ShouldReturnGroup() {
        CreationGroupRequest groupRequest = new CreationGroupRequest(
                "GROUP001", "MATH101", "PROF001", false, "01", 30, 40);
        String facultyName = "Engineering";
        String plan = "2024";
        Group createdGroup = new Group.GroupBuilder()
                .groupCode("GROUP001")
                .abbreviation("MATH101")
                .year("2024")
                .period("1")
    ...
    void deleteGroup_WhenGroupExists_ShouldReturnDeletedGroup() {
        String groupCode = "GROUP001";
        Group deletedGroup = new Group.GroupBuilder()
                .groupCode(groupCode)
                .abbreviation("MATH101")
                .year("2024")
                .period("1")
    ...
    void getSessionsByGroupCode_WhenSessionsExist_ShouldReturnSessions() {
        String groupCode = "GROUP001";
        Session session1 = new Session.SessionBuilder()
                .groupCode(groupCode)
                .classroomName("A101")
                .slot(1)
                ...
                .period("1")
                .build();
        Session session2 = new Session.SessionBuilder()
                .groupCode(groupCode)
                .classroomName("A102")
                .slot(2)
        ...
        ResponseEntity<List<Session>> response = groupController.getSessionsByStudentIdAndGroupCode(groupCode);
    ...
    void getSessionBySessionId_WhenSessionExists_ShouldReturnSession() {
        ...
        Session expectedSession = new Session.SessionBuilder()
                .groupCode("GROUP001")
                .classroomName("A101")
                .slot(1)
                .day(DayOfWeek.MONDAY)
    ...
    void createSession_WithValidData_ShouldReturnSession() {
        ...
        Session createdSession = new Session.SessionBuilder()
                .groupCode("GROUP001")
                .classroomName("A101")
                .slot(1)
                .day(DayOfWeek.MONDAY)
