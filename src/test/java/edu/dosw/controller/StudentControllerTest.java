...
class StudentControllerTest {
  ...
  @Test
  @DisplayName(
      "GET /student/{id} - Should return student with all attributes when valid ID provided")
  ...
  void updateStudent_WhenValidRequest_ReturnsUpdatedStudentWithAcademicGrade() {
    ...
    when(studentService.updateStudent(anyString(), any(StudentDto.class)))
